    ...
    <main className="">
      ...
      >
        {({ isSubmitting, setFieldValue }) => (
          <Form style={{padding:"120px"}} className="flex flex-col items-center justify-center">
            <h1 style={{color:"blue"}} className="text-3xl font-bold mb-4">Add new product</h1>
            ...
            <div style={{backgroundColor:"whitesmoke",padding:"30px"}} className="flex flex-col mb-4">
